...
// import Logo from "../../component/assets/file.png";
    ...
    <>
        ...
        <div id="about">
          ...
          <div className="hidden xs:flex md:hidden container mx-auto mt-20 sm:mt-28">
            ...
            <div className="container absolute top-40 pl-4 sm:pl-6 sm:top-[14.5rem]">
              <h1 className="font-serif text-2xl tracking-wide font-medium mb-6 sm:text-3xl">
                Simplified Complexity
              </h1>
              <p className="font-sans text-start text-[0.6rem] mb-6 sm:text-xs">
                A raw idea is complex but by having collaboration with us, the
                experts. <br />
                it can be refined or simplified.
              </p>
          ...
          <div className="hidden md:flex container mx-auto mt-28 lg:mt-[7.5rem] xl:mt-32">
            ...
            <div className="container absolute pl-12 top-[13.5rem] lg:top-[17rem] lg:pl-20 xl:top-[22rem] xl:pl-36 2xl:top-[25rem]">
              <h1 className="font-serif text-4xl tracking-wide font-medium mb-6 lg:text-5xl">
                Simplified Complexity
              </h1>
              <p className="font-sans text-start text-xs mb-6 lg:text-sm xl:text-base">
                A raw idea is complex but by having collaboration with us, the
                experts. <br />
                it can be refined or simplified.
              </p>
      ...
      <section>
        <div className="container mx-auto relative xs:hidden">
          <img
            className="bg-cover w-full opacity-30"
            src={Hexa2}
            alt="Hexagon"
          />
          <div className="absolute top-0 h-full flex items-center text-center">
            <p className="font-serif text-base font-medium leading-9 px-[3.2rem] xxs:leading-10 xxs:px-24">
              ...
              for detail in the modern and eclectic styles we predominantly
              design in.
            </p>
          </div>
        </div>
        <div className="container mx-auto relative hidden xs:flex">
          ...
          />
          <div className="absolute top-0 h-full flex items-center text-center">
            <p className="font-serif text-[0.6rem] leading-4 tracking-wider px-4 sm:text-xs sm:leading-5 sm:px-5 md:px-12 lg:px-20 lg:text-base xl:px-36 xl:text-lg">
              We at Ambiance Interior Design have been passionate about creating
              spaces reflecting the individuality of our client. Imagination and
              knowledge are the core values that drive us. We strive to push our
              imagination for a fresh look injected with design savvy and an eye
      ...
      <section className="mt-24 text-center container mx-auto">
        <h1
          id="what"
          className="font-serif text-2xl tracking-wide font-medium mb-6 lg:text-3xl 2xl:text-4xl"
        >
          What We Do
        </h1>
        <p className="font-sans text-xs px-8 xs:px-4 lg:text-sm xl:text-base">
          We strive to push our imagination for a fresh look injected with
          design savvy and an eye for <br />
          detail in the modern and eclectic styles we predominantly design in.
        </p>
      </section>
      <section className="mt-12 gap-4 container mx-auto">
        <div className="flex flex-row justify-center">
          <Swiper
            ...
            breakpoints={{
              520: { slidesPerView: 2, spaceBetween: -130 },
              640: { slidesPerView: 2, spaceBetween: -130 },
              768: { slidesPerView: 2, spaceBetween: -240 },
              1024: { slidesPerView: 3, spaceBetween: -200 },
              1280: { slidesPerView: 3, spaceBetween: -290 },
              1536: { slidesPerView: 4, spaceBetween: -190 },
            }}
          >
            <SwiperSlide>
              <div className="flex flex-col items-center group transition-all">
                <div>
                  <img
                    className="h-72 group-hover:-translate-y-1 transition-all xs:h-52 sm:h-64 md:h-72 xl:h-96"
                    src={Space}
                    alt="Space Planning"
                  />
                  <h4 className="font-sans text-sm font-medium pl-2 pt-4 group-hover:-translate-y-1 group-hover:text-orange-500 transition-all">
                    Space Planning
                  </h4>
                </div>
              </div>
      ...
      <section className="mt-24 container mx-auto xs:grid grid-cols-2">
        ...
        <div className="flex flex-col text-center mt-12 justify-center px-4 xs:text-left xs:mt-0 sm:px-8 lg:px-16 xl:px-28 2xl:px-36">
          <h1 className="font-serif text-2xl tracking-wide font-medium mb-6 lg:text-3xl 2xl:text-4xl">
            Projects
          </h1>
          <p className="font-sans text-xs mb-6 xs:mb-4 md:mb-6 lg:text-sm xl:text-base">
        ...
        <div className="container mx-auto relative xs:hidden">
          ...
          <div className="absolute top-0 h-full flex flex-col justify-center">
            <div className="flex flex-col items-center text-center px-4">
              ...
              <p className="font-serif text-base font-medium leading-9 mb-6 px-6 xxs:leading-10 xxs:px-24">
                It is very satisfying when a decision we make turns out to have
                been the best one.
              </p>
              <p className="font-serif text-base font-medium leading-9 px-6 xxs:leading-10">
                Jane Doe
              </p>
            </div>
            <div className="flex justify-center gap-12 mt-8">
        ...
        <div className="container mx-auto relative hidden xs:flex xs:justify-center">
          ...
          <div className="absolute top-0 h-full flex flex-row items-center xs:px-4 sm:px-8 md:px-12 lg:px-20 xl:px-36">
            ...
            <div className="flex flex-col items-center text-center">
              <img
                className="w-8 mb-2 sm:w-10 md:w-12 lg:mb-4"
                src={Right}
                alt="Right Quote"
              />
              <p className="font-serif text-[0.6rem] leading-4 tracking-wider px-4 sm:text-xs sm:leading-5 sm:px-20 sm:mb-2 md:px-36 lg:px-44 lg:text-base lg:mb-4 xl:px-52 xl:text-lg">
                It is very satisfying when a decision we make turns out to have
                been the best one.
              </p>
              <p className="font-serif text-[0.6rem] leading-4 tracking-wider px-4 sm:text-xs sm:leading-5 lg:text-base xl:text-lg">
                Jane Doe
              </p>
            </div>
            <div className="button-next-slide">
      ...
      <section className="mt-24 container mx-auto xs:grid grid-cols-2">
        <div className="flex justify-center order-2">
          <img
            className="px-4 sm:pr-8 md:pr-12 lg:pr-28 xl:pr-36"
            src={BaseOne}
            alt="People Planning"
          />
        </div>
      ...
      <section className="container mx-auto relative">
        <div className="">
          <img
            className="w-full py-44 3xs:py-32 xxs:py-24 xs:hidden"
            src={BaseTwoSmall}
            alt="Wood Furniture"
          />
          <img
            className="w-full hidden py-[17.5rem] xs:flex xl:py-52 2xl:py-48"
            src={BaseTwo}
            alt="Wood Furniture"
          />
          <div
            id="career"
            className="absolute top-0 mt-24 mx-6 py-8 px-12 bg-white text-center shadow-md shadow-slate-200 xxs:py-12 xs:mx-12 sm:mx-16 md:mx-28 lg:mx-56 xl:mx-80 2xl:mx-[26rem]"
          >
            <h1 className="font-serif text-2xl tracking-wide font-medium mb-6 3xs:px-8 xxs:px-14 lg:text-3xl 2xl:text-4xl">
              Your Space Should Reflect Who You Are
            </h1>
            <p className="font-sans text-xs mb-6 xs:mb-4 md:mb-6 lg:text-sm xl:text-base">
              Ready to get started? Let us know about your project!
            </p>
            <form ref={form} onSubmit={sendEmail} className="flex flex-col gap-4 mb-8 xxs:px-4 xs:px-8 sm:px-16 md:px-20 2xl:px-28">
      ...
      <section className="mt-24 container mx-auto flex flex-col items-center gap-16 xs:mt-28 md:mt-20 lg:mt-12 xl:mt-24">
        <div className="">
          {/* <a href="#home">
            <img
              className="h-8 cursor-pointer w-32"
              src={Logo}
              alt="Ambiance Interior Design Studio"
            />
          </a> */}
        </div>
